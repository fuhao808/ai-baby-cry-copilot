    ...
    await _firestore.collection('cry_logs').doc(result.recordId).set(
      {
        ...
        'analysis_family': result.analysisFamily,
        'screening_label': result.screeningLabel,
        'cry_detected': result.cryDetected,
        'baby_voice_detected': result.babyVoiceDetected,
        'detected_sound': result.detectedSound,
        'primary_pattern': result.primaryPattern,
        'phonetic_patterns': result.phoneticPatterns,
        'mixed_types': result.mixedTypes,
